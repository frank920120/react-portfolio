  ...
  constructor(props) {
    ...
    this.state = {
      ...
      skill: [
        ...
        "HTML, Css, Reactjs, React Native, Nodejs, Express, GraphQL, MongoDB, Postgres, Meteorjs, Redux, Javascript, Jquery, Sass, PHP, WordPress"
      ],
              ...
              <SkillContent scroll={this.state.ImageScroll} key={index}>
                ...
                <SkilTool>
                  {this.state.ToolList[index].map((list, index) => {
                    return <SkillToolItem key={index}>{list}</SkillToolItem>;
                  })}
                </SkilTool>
              </SkillContent>
            );
